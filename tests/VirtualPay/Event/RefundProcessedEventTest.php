...
class RefundProcessedEventTest extends TestCase
{
    /**
    ...
    public function testConstructorStoresMessageData()
    {
        ...
        $event = new RefundProcessedEvent($message);
    ...
    public function testGetterMethodsReturnCorrectValues()
    {
        ...
        $this->assertEquals('xpay_refund_notify', $event->getEvent());
        ...
        $this->assertEquals(50, $event->getAmount());
