...
/**
 * Complaint Filed Event for Virtual Pay.
 *
 * Triggered when user files a complaint.
 */
class ComplaintFiledEvent extends GenericEvent
{
    /**
     * Create a new ComplaintFiledEvent instance.
     *
